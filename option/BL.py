...
parser.add_argument('--end_lr', default=0.0000001, type=float, help='end learning rate')
...
parser.add_argument('--w_loss_CLIP', default=0.1, type=float, help='weight of loss CLIP')
parser.add_argument('--w_loss_L1', default=1, type=float, help='weight of loss L1')


parser.add_argument('--exp_dir', type=str, default='./experiment')
parser.add_argument('--model_name', type=str, default='BL_THaze')
...
parser.add_argument('--dataset', type=str, default='THaze')
